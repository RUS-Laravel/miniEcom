            ...
            <div class="container relative clearfix">
                <div class="title-holder">
                    <div class="title-text">
                        <h1 class="uppercase">Newsletter List</h1>
                        <ol class="breadcrumb">
                            <li>
                                    ...
                                    <div class="product-item clearfix">
                                        <div class="product-img hover-trigger">
                                            ...
                                            <div class="product-label">
                                                ...
                                                @endif
                                                <button type="submit" class="btn" data-insert="newsletter" data-url="{{ route('product.add.newsletter', $product->id) }}"><span>Add Newsletter</span></button>
